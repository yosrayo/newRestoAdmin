...
export class GestionPlatComponent implements OnInit {
  ...
  constructor(public platservice : PlatService, private storage: AngularFireStorage,
...
{ this.platservice.supprimeProduit(data);
}
}
Updatarecord(recorddata)
{
  ...
  this.platservice.updateProduct(this.upid, record);
